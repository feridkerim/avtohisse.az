...
export default function CreateAdForm() {
  ...
  const onSubmit: SubmitHandler<AdFormValues> = (data) => console.log("Final Data:", data);
        ...
        {step === 1 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
            ...
            <div className="space-y-3">
              ...
              <ToggleGroup
                type="single"
                onValueChange={(v) => setValue("vehicleType", v as string)}
        ...
        {step === 2 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4">
            ...
            <div className="p-5 bg-slate-50 rounded-2xl border-2 border-dashed space-y-3">
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <Checkbox
                    id="no-oem"
                    onCheckedChange={(v) => setValue("dontKnowOem", v === true)}
                  />
                  <label
                    htmlFor="no-oem"
            ...
            <div className="space-y-3">
              ...
              <ToggleGroup
                type="single"
                onValueChange={(v) => setValue("condition", v as string)}
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col gap-2 pt-2">
                <label className="flex items-center gap-2 text-sm cursor-pointer">
                  <Checkbox
                    onCheckedChange={(v) => setValue("isNegotiable", v === true)}
                  />{" "}
                  Razılaşma yolu ilə
                </label>
                <label className="flex items-center gap-2 text-sm cursor-pointer">
                  <Checkbox
                    onCheckedChange={(v) => setValue("isBarter", v === true)}
                  />{" "}
                  Barter mümkündür
                </label>
              </div>
